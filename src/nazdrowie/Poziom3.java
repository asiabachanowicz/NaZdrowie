...
public class Poziom3 extends JPanel implements ActionListener, KeyListener   {
   ...
   //zmienna bool okreslajaca czy gre wygrano/przegrano
    ...
    public void paintComponent(Graphics gs){
        ...
        for(int i=0;i<fFood.length;i++){
            fFood[i].calculatePathPos(GPars.MoveMODE=3);
                if(!fFood[i].hit){
        ...
        for(int i=0;i<fFood2.length;i++){
            fFood2[i].calculatePathPos(GPars.MoveMODE=3);
                if(!fFood2[i].hit){
